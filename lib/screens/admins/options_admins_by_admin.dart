...
class SearchDetailsAdminByAdmin extends StatefulWidget {
  const SearchDetailsAdminByAdmin({Key? key}) : super(key: key);
  static const String id = '/SearchDetailsDeleteAdminScrn';
  @override
  State<SearchDetailsAdminByAdmin> createState() => _SearchDetailsAdminByAdminState();
}


class _SearchDetailsAdminByAdminState extends State<SearchDetailsAdminByAdmin> {
  ...
  Future <GetAllAdminsUsersDeliveryMenPg> getAdmins({String? name} ) async {
    ...
    Uri _tokenUrl = Uri.parse('https://hbtknet.com/admin/admin/getAllAdmins?page=$page');
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 10,),
             ...
             decoration: InputDecoration(hintText: 'Buscar un admin',
            ...
            BoxDecoration(color: Colors.black, borderRadius: BorderRadius.circular(10.0)),
                child: Padding(padding: const EdgeInsets.all(8.0),
                  child: Text('No hay adminstradores',style: TextStyle(fontSize: 20,color: Colors.white),),))
                :  Expanded(
                          ...
                          child: Column(
                            ...
                            GestureDetector(
                              onTap: (){
                                ...
                                (context)=>AdminsProfileScreenByAdmin (selectedId:MemberList[index].id ,),
                                ),);
