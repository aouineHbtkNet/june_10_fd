...
class AlDomicilioEncamino extends StatefulWidget {
  const AlDomicilioEncamino({Key? key}) : super(key: key);
  static const String id = '/AlDomicilioEncamino';
  @override
  State<AlDomicilioEncamino> createState() => _AlDomicilioEncaminoState();
}

class _AlDomicilioEncaminoState extends State<AlDomicilioEncamino> {
              ...
              child: Card(
                ...
                child: Column(children: [
                  SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                    child: Text('Al domicilio :En camino', style: TextStyle(fontSize: 20),),)),
                  Divider(thickness: 2,),
                  SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
