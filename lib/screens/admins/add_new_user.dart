...
class AddNewUser extends StatefulWidget {
  static const String id = '/AddNewUser';
      ...
      body: SafeArea(
        ...
        Column(
          children: [
            ...
            SizedBox(height: 20,),
            Text('Agregar un nuevo cliente', style: TextStyle(fontSize: 20, color: Color(0xFF00007f)  ),),
            SizedBox(height: 20,),
            Divider(thickness: 2,color: Colors.blueGrey,),
                      ...
                      TextButton(
                        ...
                        onPressed:() async{
                          if (_addnewadminkey.currentState!.validate()) {
                            ...
                            var response = await AddNewAdminUsersDeliveryManByAdmin().addNewUserByAdmin(
