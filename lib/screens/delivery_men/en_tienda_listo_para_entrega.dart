...
class EnLaTiendaListoParaEntrega extends StatefulWidget {
  const EnLaTiendaListoParaEntrega({Key? key}) : super(key: key);
  static const String id = '/EnLaTiendaListoParaEntrega';
  @override
  State<EnLaTiendaListoParaEntrega> createState() => _EnLaTiendaListoParaEntregaState();
}

class _EnLaTiendaListoParaEntregaState extends State<EnLaTiendaListoParaEntrega> {
  ...
  initFetchData() async{
    ...
    dataFromApi = await getOrdersByFilters(
        ...
        user_id: '',
        orderTruckingNumber: '',
        orderStatus:'Listo para la entrega' ,
            ...
            child: Card(
              ...
              child: Column(children: [
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                  child: Text('  En tienda : Listo para la entrega', style: TextStyle(fontSize: 20),),)),
                Divider(thickness: 2,),
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [Expanded(child: ElevatedButton(
                            ...
                            onPressed: () async{
                              ...
                              await ModifyStatusForDomiciliarios().setToStatusForDomiciliarios(id4??0,'Entregado');
                              await initFetchData();
                            }, child: Text('Entregado',style: TextStyle(fontSize: 20,),)),),],),
