...
class AlDomicilioEnPreparacion extends StatefulWidget {
  const AlDomicilioEnPreparacion({Key? key}) : super(key: key);
  static const String id = '/AlDomicilioEnPreparacion';
  @override
  State<AlDomicilioEnPreparacion> createState() => _AlDomicilioEnPreparacionState();
}

class _AlDomicilioEnPreparacionState extends State<AlDomicilioEnPreparacion> {
              ...
              child: Card(
                ...
                child: Column(children: [
                  SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                    child: Text('Al domicilio :En preparación', style: TextStyle(fontSize: 20),),)),
                  Divider(thickness: 2,),
                  SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                        ...
                        child: Column(children: [
                          ...
                          Row(children: [Expanded(child: ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                await ModifyStatusForDomiciliarios().setToStatusForDomiciliarios(id4??0,'En camino');
                                await initFetchData();
                              }, child: Text('En camino',style: TextStyle(fontSize: 20,),)),),],),
