...
class EnLaTiendaPendiente extends StatefulWidget {
  const EnLaTiendaPendiente({Key? key}) : super(key: key);
  static const String id = '/EnLaTiendaPendiente';
  @override
  State<EnLaTiendaPendiente> createState() => _EnLaTiendaPendienteState();
}

class _EnLaTiendaPendienteState extends State<EnLaTiendaPendiente> {
            ...
            child: Card(
              ...
              child: Column(children: [
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                  child: Text('  En tienda : Pendientes ', style: TextStyle(fontSize: 20),),)),
                Divider(thickness: 2,),
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                            ...
                            child: Form(key: _dropdownPopUpkey8796,
                              child: DropdownButtonHideUnderline(
                                child: DropdownButtonFormField(hint: Text('Estado'),
                                  ...
                                  items:['Recibido', 'En preparación', 'Listo para la entrega','Entregado',].map((String items) {
