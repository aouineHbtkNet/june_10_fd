...
class _DeliveryMenProfileScreenState extends State<DeliveryMenProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(child: Padding(padding: const EdgeInsets.all(12.0),
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              ...
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    IconButton(onPressed: () async {Navigator.of(context).pushNamed(DeliveryEditAccount.id);},
