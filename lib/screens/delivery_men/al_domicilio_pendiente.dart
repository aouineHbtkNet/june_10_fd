...
class AlDomicilioPendiente extends StatefulWidget {
  const AlDomicilioPendiente({Key? key}) : super(key: key);
  static const String id = '/AlDomicilioPendiente';
  @override
  State<AlDomicilioPendiente> createState() => _AlDomicilioPendienteState();
}

class _AlDomicilioPendienteState extends State<AlDomicilioPendiente> {
  ...
  final _dropdownPopUpkey8796 = GlobalKey<FormState>();
  ...
  initFetchData() async{
    ...
    dataFromApi = await getOrdersByFilters(
        ...
        orderManeraEntrega:'Al domicilio',
            ...
            child: Card(
              ...
              child: Column(children: [
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                  child: Text('Al domicilio : Pendientes ', style: TextStyle(fontSize: 20),),)),
                Divider(thickness: 2,),
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                    ...
                    showDialog(context: context, builder: (context) {return AlertDialog(
                      content: SingleChildScrollView(child: Column(
                        children: [SizedBox(height: 10,), Padding(
                            ...
                            child: Form(key: _dropdownPopUpkey8796,
                              child: DropdownButtonHideUnderline(
                                child: DropdownButtonFormField(hint: Text('Estado'),
                                  ...
                                  items:['Recibido', 'En preparación', 'En camino','Entregado',].map((String items) {
                      ...
                      actions: [Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          ...
                          ElevatedButton(onPressed: () async {
                            ...
                            if (_dropdownPopUpkey8796.currentState!.validate()) {
                              _dropdownPopUpkey8796.currentState!.save();
                              if(estadoSelectadoForPopUp==null){
                                ...
                                Navigator.of(context).pop();
                                await ModifyStatusForDomiciliarios().setToStatusForDomiciliarios(idInt??0,estadoSelectadoForPopUp!);
                                setState(() {estadoSelectadoForPopUp=null;});
                                await initFetchData();
                              }}}, child: Center(child: Text('Ok'))),],)
                      ],);});}
                    ...
                    return Card(elevation: 20, child: Padding(
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [Expanded(child: ElevatedButton(
                            style: ElevatedButton.styleFrom(primary: Colors.amber, onPrimary: Colors.white,
                              elevation: 20, shadowColor: Colors.amber,),
                            onPressed: () async{
                              showsStatusDropdown(context);
                            }, child: Text('Cambiar el estado',style: TextStyle(fontSize: 20,),)),),],),
