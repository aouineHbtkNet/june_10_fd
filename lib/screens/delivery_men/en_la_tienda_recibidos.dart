...
class EnLatiendaRecibido extends StatefulWidget {
  const EnLatiendaRecibido({Key? key}) : super(key: key);
  static const String id = '/EnLatiendaRecibido';
  @override
  State<EnLatiendaRecibido> createState() => _EnLatiendaRecibidoState();
}

class _EnLatiendaRecibidoState extends State<EnLatiendaRecibido> {
           ...
           child: Card(
             ...
             child: Column(children: [
               SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                 child: Text('  En tienda : recibido', style: TextStyle(fontSize: 20),),)),
               Divider(thickness: 2,),
               SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                             ...
                             child: Column(children: [
                               ...
                               Row(children: [Expanded(child: ElevatedButton(
                                   ...
                                   onPressed: () async{
                                     ...
                                     await ModifyStatusForDomiciliarios().setToStatusForDomiciliarios(id4??0,'En preparación');
                                     await initFetchData();
                                   }, child: Text('En preparación',style: TextStyle(fontSize: 20,),)),),],),
...
//       firstDate: DateTime(2022), lastDate:DateTime(2040));
//   if (newDateTimeRange==null) return;setState(() {
...
//   child: Text('Dias : ${_difference}',style: TextStyle(fontSize: 20,color: Colors.blueGrey),),)),
