...
class EnLaTiendaEnPreparacion extends StatefulWidget {
  const EnLaTiendaEnPreparacion({Key? key}) : super(key: key);
  static const String id = '/EnLaTiendaEnPreparacion';
  @override
  State<EnLaTiendaEnPreparacion> createState() => _EnLaTiendaEnPreparacionState();
}

class _EnLaTiendaEnPreparacionState extends State<EnLaTiendaEnPreparacion> {
            ...
            child: Card(
              ...
              child: Column(children: [
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                  child: Text('  En tienda : enpreparación ', style: TextStyle(fontSize: 20),),)),
                Divider(thickness: 2,),
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [Expanded(child: ElevatedButton(
                            ...
                            onPressed: () async{
                              ...
                              await ModifyStatusForDomiciliarios().setToStatusForDomiciliarios(id4??0,'Listo para la entrega');
                              await initFetchData();
                            }, child: Text('Listo para la entrega',style: TextStyle(fontSize: 20,),)),),],),
