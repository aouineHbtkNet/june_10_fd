...
class PlaceOrder{
  ...
  Future  placeOrder( {
    ...
    String? manera_pago ,
    String? manera_pago_details ,// added recently
    String? observation ,// added recently
    double ? delivery_fee,
    ...
    final url = Uri.parse('https://hbtknet.com/client/placeOrder');
    ...
    Map<String, dynamic> body = {
      ...
      'manera_pago_details': manera_pago_details,//recently added
      ...
      'observation': observation,//recently added
