...
class AlDomicilioEntregado extends StatefulWidget {
  const AlDomicilioEntregado({Key? key}) : super(key: key);
  static const String id = '/AlDomicilioEntregado';
  @override
  State<AlDomicilioEntregado> createState() => _AlDomicilioEntregadoState();
}

class _AlDomicilioEntregadoState extends State<AlDomicilioEntregado> {
            ...
            child: Card(
              ...
              child: Column(children: [
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
                  child: Text('Al domicilio :Entregado', style: TextStyle(fontSize: 20),),)),
                Divider(thickness: 2,),
                SingleChildScrollView(scrollDirection:Axis.horizontal,child: Padding(padding: const EdgeInsets.all(8.0),
